...
-(void)initNoWithSize:(CGSize ) size
{
    ...
    [path_1 addArcWithCenter:CGPointMake(0, 0) radius:6 startAngle:0 endAngle:2*M_PI clockwise:YES];
    [path_1 closePath];
    ...
    _no1Animation = [CABasicAnimation animationWithKeyPath:@"opacity"];
    _no1Animation.repeatCount = 1000;
    _no1Animation.duration = 1.23;
    _no1Animation.fromValue = [NSNumber numberWithFloat:1];
    _no1Animation.toValue   = [NSNumber numberWithFloat:0];
    _no1Animation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionLinear];
